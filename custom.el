...
(defun centaur-setup-fonts ()
  ...
  (when (display-graphic-p)
    ;; Set default font
    (cl-loop for font in '("Maple Mono CN" "FiraCode Nerd Font" "CaskaydiaCove Nerd Font"
    ...
    (cl-loop for font in '("Apple Symbols" "Segoe UI Symbol" "Symbola" "Symbol" "Iosevka")
             when (font-available-p font)
    ...
    (cl-loop for font in '("Maple Mono CN" "PingFang SC" "LXGW Neo Xihei" "LXGW WenKai Mono" "WenQuanYi Micro Hei Mono"
